        ...
        <div class="row">
            <div class="col-md-4 mb-3">
                <select class="custom-select" name="sort_column">
                    ...
                    <option value="order_no" @if( request('sort_column') == "order_no" )selected @endif >並び替え: 並び順番号</option>
                </select>
            </div>
            <div class="col-md-4 mb-3">
        ...
        <table class="table table-striped table-sm">
            ...
            @foreach( $search_results as  $search_result )
                <tr>
                    ...
                    <td><a href="{{ route('admin.product_categories.show',['product_category' => $search_result->id]) }}">{{ $search_result->name }}</a></td>
                    <td>{{ $search_result->order_no }}</td>
                </tr>
            @endforeach
            </tbody>
        </table>
